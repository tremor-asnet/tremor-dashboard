  ...
  return (
    <Flex className="antialiased font-primary flex-col items-start md:w-[426px]">
      ...
      <Flex className="mt-5 flex-col items-start justify-start">
        <Text className="text-tremor-title font-semibold text-primary dark:text-dark-romance">
          Price
        </Text>
        <Flex
      ...
      <Text className="p-2 mt-4 font-bold text-fewter bg-seldom text-xs rounded-tremor-small leading-[9px] tracking-[0.18px] uppercase">
        In Stock
      </Text>
      <Flex className="flex-col items-start mt-10">
        ...
        <ul className="text-secondary pl-6 list-outside list-disc text-tremor-title">
          <li>
      ...
      <Flex className="mt-6">
        <InputField type="number" label="Quantity" defaultValue={quantity} />
      </Flex>
      <Link
        href="#"
