  ...
  <>
    ...
    <Flex>
      <label
        ...
        <Text className="p-4 ">Drop files here to upload</Text>
        <input id="upload_products" type="file" multiple className="hidden" />
        {/* Images preview */}
        <Flex justifyContent="start" className="hidden">
          <Flex flexDirection="col" className="relative w-auto m-4 group">
            {/* Image url */}
            ...
            <Flex
              ...
              className="absolute z-20 min-h-full max-h-full px-2 py-6">
            ...
            {/* Success mark */}
            <Flex className="absolute z-30 top-1/2 left-1/2 -mt-[27px] -ml-[27px] opacity-0">
              <svg
                width="54px"
                height="54px"
                viewBox="0 0 54 54"
            ...
            {/* Error mark */}
            <Flex className="absolute z-30 top-1/2 left-1/2 -mt-[27px] -ml-[27px] opacity-100">
              <svg
                width="54px"
                height="54px"
                viewBox="0 0 54 54"
            ...
            <Button
              className="text-primary font-normal hover:text-primary dark:text-dark-primary text-xs px-6 py-0"
              variant="light">
              Remove file
            </Button>
          </Flex>
