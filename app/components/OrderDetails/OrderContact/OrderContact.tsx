    ...
    <Flex className="flex-wrap sm:flex-nowrap">
      ...
      <Flex>
        <Flex className="flex-col items-end">
          ...
          {/* <Text className="mt-3 text-sm dark:text-dark-romance font-light opacity-100 text-secondary text-right leading-[21px] tracking-[0.4px] max-w-[100px] lg:max-w-[200px] xl:max-w-[300px] 2xl:max-w-[400px] min-w-[100px]"> */}
