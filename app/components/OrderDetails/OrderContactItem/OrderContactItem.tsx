...
const OrderContactItem = ({ orderContact }: OrderContactItemProps) => (
  <Flex className="flex-col md:flex-row pb-4 mb-4 border-0 border-b border-gray-100 last:border-transparent last:p-0 last:m-0">
    <Flex>
      <Flex className="w-auto justify-start">
        ...
        <Flex className="w-auto flex-col justify-start items-start">
          <Title className="text-primary font-semibold capitalize leading-[26px] tracking-[0.12px] truncate max-w-[100px] lg:max-w-[200px] xl:max-w-[300px] 2xl:max-w-[400px] min-w-[100px]">
    ...
    <Flex>
      <Flex className="flex-col items-end">
        <Button className="antialiased min-w-[64px] py-[12px] text-center uppercase sm:px-4 bg-gradient-primary dark:bg-gradient-pickled rounded-lg border-0 hover:shadow-btn-primary-hover px-2 py-1.5 leading-[17px] tracking-[0.35px]">
          <Text className="uppercase py-[2px] text-xs font-bold text-white dark:text-white uppercase">
            contact us
          </Text>
        </Button>
